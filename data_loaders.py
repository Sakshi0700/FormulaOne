...
class options_loader():
    ...
    def __init__(self, db, year_start, year_end):
        self.db = db
        self.year_start = year_start
        self.year_end = year_end
        self.year = dt.date.today().year
        self.tm_years = self.set_tm_years()
        self.race_ids = self.set_init_raceId()
        self.event_labels = self.set_event_labels()
    ...
    def query(self, selection, table, where=condition):
